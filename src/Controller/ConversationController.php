...
/**
 * @Route("/app/conversations", name="conversations.")
 */
...
ConversationRepository $conversationRepository)
    ...
    public function getConvs(Request $request) {
        ...
        $conversations = $this->conversationRepository->findConversationsByUser(1);
        
        $hubUrl = $this->getParameter('mercure.default_hub');
        $hubUrl = "http://localhost:9090/.well-known/mercure";
